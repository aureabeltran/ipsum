...
class ContactFormAnimate extends Component {
                ...
                <Form onSubmit={(e)=>this.handleSubmit(e)}  >
                    <Collapse in={this.state.open}>
                        <div id="example-collapse-text">
                            <div className={this.state.toggleform === 1 ? 'fadeIn' : 'fadeOut d-none'}>
                                ...
                                <div className="row">
                                    <div className="form-group col-lg-12 text-left">
                                        ...
                                        {this.state.country === '' ? <small>Este campo es obligatorio*</small> : null}
                                    </div>
                                    <div className="form-group col-lg-12 text-left">
                                        ...
                                        {this.state.jobtitle === '' ? <small>Este campo es obligatorio*</small> : null}
                                    </div>
                                </div>
                                <div className="row">
                                    <div className="form-group col-lg-6 col-md-6">
                                    ...
                                    <div className="form-group col-lg-6 col-md-6 text-left">
                                        ...
                                        {this.state.industry === '' ? <small>Este campo es obligatorio*</small> : null}
                                    </div>
                                </div>
                            </div>
                            <div className={this.state.toggleform === 2 ? 'fadeIn' : 'fadeOut d-none'}>
                                <article className="py-5 text-center">
                                    ...
                                    <h4 className="font-weight-light">Nos pondremos en contacto a la brevedad</h4>
                                </article>
                            </div>
                            <div className={this.state.toggleform === 3 ? 'fadeIn' : 'fadeOut d-none'}>
                                <article className="py-5 text-center">
                                    <h1 >Ha ocurrido un error</h1>
                                    <h4 className="font-weight-light">Ha ocurrido un error mientras enviabamos la información.</h4>
                                    <button className="main-btn orange-btn mt-5" type="button" onClick={()=>this.setState({toggleform: 1})}><span>Intentar denuevo</span></button>
                                </article>
                            </div>
                        </div>
                    </Collapse>
                    <div className="row">
                        <div className="col-xl-12">
                            <button className={this.state.open && this.state.toggleform === 1 ? "main-btn blue-btn mt-5" : "main-btn blue-btn d-none"} disabled={this.state.country === '' || this.state.jobtitle === '' || this.state.industry === ''} ><span>Quiero mi demo</span></button>
                            <button
                                className={this.state.open ? "main-btn blue-btn d-none" : "main-btn blue-btn"}
                                type="button"
...
export default ContactFormAnimate;